...
fn lookup_speed(position: vec2f) -> vec2f {
    ...
    let speed = mix(flowUniform.flowBoundary.xy, flowUniform.flowBoundary.zw, get_speed(uv));
    let speed1 = mix(flowUniform.flowBoundary.xy, flowUniform.flowBoundary.zw, get_speed(uv));
